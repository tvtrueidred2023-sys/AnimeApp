...
public class GoSeriesSource implements AnimeSource {
    ...
    public String getBaseUrl() {
        return "https://goseries4k.com/category/ดู-ซีรี่ย์ออนไลน์/";
    }

    @Override
    public String getSearchUrl(String keyword) {
        return "https://goseries4k.com/?s=" + keyword;
    }
    ...
    private List<AnimeItem> parseAnimeItems(Document doc) {
        ...
        for (Element movie : movies) {
            ...
            if (link != null && img != null && titleElement != null) {
                ...
                Element subtitleElement = movie.selectFirst("div.qa-label.qa-bg");
                String subtitleText = subtitleElement != null ? subtitleElement.text().trim() : "";
